...
screenshots per language. They are historical captures, not ready for the 1.4.2 submission.
...
For 1.4.2, recapture the new Stable reading and Hide filler words controls and add a saved-session history image in each listing language. Capture only disposable demo transcripts, with no private meeting text. The existing images have not been refreshed by this release preparation.

For 1.4.2 also capture Meeting profiles, the always-visible appearance previews/presets, and a titled
...
For the 1.4.2 interface, capture the profile picker above step 01, Captions with presets and

...
fourth component appended. It reads `1.4.2.0` at the time of writing and whatever that file
...
Build 1.4.2 with the normal committed configuration and complete the
...
```text
src-tauri/target/msix/Live Translation & Subtitles_1.4.2.0_arm64.msix
src-tauri/target/msix/Live Translation & Subtitles_1.4.2.0.msixbundle
```
...
Substitute the current `tauri.conf.json` version for `1.4.2` throughout this file. Every
